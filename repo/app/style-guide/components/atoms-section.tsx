...
import { ColorsAtoms } from "./atoms/colors-atoms"
...
export function AtomsSection({
  ...
  const atomTypes = [
    { id: "colors", name: "Colours", icon: Palette, count: 23, description: "Brand colours, gradients, and semantic tokens" },
