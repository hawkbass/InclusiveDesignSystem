...
const Button = React__namespace.forwardRef(({ className, variant, size, asChild = false, loading = false, loadingText, children, disabled, ...props }, ref) => {
    ...
    if (asChild) {
        return (jsxRuntime.jsx(Comp, { className: cn(buttonVariants({ variant, size, className })), ref: ref, disabled: isDisabled, "aria-disabled": isDisabled, ...props, children: children }));
    }
    return (jsxRuntime.jsxs(Comp, { className: cn(buttonVariants({ variant, size, className })), ref: ref, disabled: isDisabled, "aria-disabled": isDisabled, ...props, children: [loading && (jsxRuntime.jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin", "aria-hidden": "true" })), loading ? loadingText || children : children] }));
});
