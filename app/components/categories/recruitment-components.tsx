...
const components = [
  ...
  <div className="flex gap-3">
    ...
    component: (
      <div className="w-full max-w-md space-y-4">
        {[
          { event: "Application submitted", time: "2 hours ago", type: "application", colour: "bg-blue-400" },
          { event: "Resume reviewed", time: "1 hour ago", type: "review", colour: "bg-yellow-400" },
          { event: "Phone screening scheduled", time: "30 min ago", type: "interview", colour: "bg-green-400" },
          { event: "Technical assessment sent", time: "15 min ago", type: "assessment", colour: "bg-purple-400" }
        ].map((item, index) => (
