...
const components = [
  ...
  },
  {
    ...
    code: `<div className="w-64 bg-slate-800/50 border-r border-slate-700/50 backdrop-blur-sm">
  ...
  <div className="p-2">
    ...
    component: (
      <div className="w-64 bg-slate-800/50 border border-slate-700/50 rounded-lg backdrop-blur-sm">
        <div className="p-4 border-b border-slate-700/50">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 bg-gradient-to-r from-fuchsia-500 to-purple-500 rounded-full flex items-center justify-center text-white font-medium">
              SW
  ...
  },
  {
    ...
    code: `<div className="absolute right-4 top-16 w-96 bg-slate-900/95 border border-slate-700/50 rounded-xl shadow-2xl backdrop-blur-xl">
  ...
  <div className="max-h-80 overflow-y-auto">
    ...
    component: (
      <div className="w-96 bg-slate-900/95 border border-slate-700/50 rounded-xl shadow-2xl backdrop-blur-xl">
        <div className="p-4 border-b border-slate-700/50 bg-gradient-to-r from-slate-800/50 to-slate-800/30 rounded-t-xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-gradient-to-r from-fuchsia-500 to-purple-500 rounded-full flex items-center justify-center">
