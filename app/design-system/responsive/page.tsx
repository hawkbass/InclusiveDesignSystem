        ...
        <CardContent>
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              <div key={stat.device} className="text-center p-6 bg-slate-900/30 rounded-lg border border-slate-700/30 hover:border-fuchsia-500/30 transition-colours group" style={{ transitionDuration: `${1 / safeAnimationSpeed}s` }}>
