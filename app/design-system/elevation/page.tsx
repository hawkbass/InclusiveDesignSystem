              ...
              <div>
                ...
                <ul className="space-y-2 text-slate-400">
                  <li className="flex items-center gap-2">
                    ...
                    Dark-first shadow optimization
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-400" />
        ...
        <CardContent>
          <div className="space-y-4">
            {shadowTokens.map((shadow) => (
              <div key={shadow.name} className="flex items-center justify-between p-4 bg-slate-900/30 rounded-lg border border-slate-700/30 hover:border-fuchsia-500/30 transition-colors group" style={{ transitionDuration: `${1 / safeAnimationSpeed}s` }}>
                <div className="flex items-center gap-4">
                  <div 
            ...
            {coloredShadows.map((shadow) => (
              <div key={shadow.name} className="flex items-center justify-between p-4 bg-slate-900/30 rounded-lg border border-slate-700/30 hover:border-fuchsia-500/30 transition-colors group" style={{ transitionDuration: `${1 / safeAnimationSpeed}s` }}>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-mono text-sm text-slate-200">{shadow.name}</div>
                    <div className="text-xs text-slate-400 mb-1 capitalize">{shadow.color} variant</div>
                    <div className="text-xs text-slate-500">{shadow.usage}</div>
                  </div>
                </div>
                <div className="flex items-center gap-2">
        ...
        <CardContent>
          <div className="space-y-4">
            {blurEffects.map((blur) => (
              <div key={blur.name} className="flex items-center justify-between p-4 bg-slate-900/30 rounded-lg border border-slate-700/30 hover:border-fuchsia-500/30 transition-colors group" style={{ transitionDuration: `${1 / safeAnimationSpeed}s` }}>
                <div className="flex items-center gap-4">
